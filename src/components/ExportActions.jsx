...
export default function ExportActions({ meta, details, event, timeline, experts, matrix, gaps, documents }) {
  ...
  const matrixHeaders = ["תחום", ...["prediction", "ortho", "neuro", "psych", "rheum", "malal"].map((id) => experts.find((item) => item.id === id)?.name || "מומחה")];
